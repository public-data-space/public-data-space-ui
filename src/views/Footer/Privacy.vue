<template>
  <div>
    ...
    <p>
      ...
      es sich dabei handelt, auf welche Weise sie verarbeitet werden und welche Rechte Ihnen diesbezüglich zustehen.

      Personenbezogene Daten sind gemäß Art. 4 Nr. 1 Datenschutzgrundverordnung (DSGVO) alle Informationen, die sich auf
      eine identifizierte oder identifizierbare natürliche Person beziehen.
    </p>

    <h3>Name und Kontaktdaten des für die Verarbeitung Verantwortlichen sowie des betrieblichen Datenschutzbeauftragten
    </h3>
    <p>Diese Datenschutzinformation gilt für die Datenverarbeitung unseres Angebots FOKUS Digital durch den
      Verantwortlichen:</p>
    <p>
      ...
      datenschutz@zv.fraunhofer.de erreichbar.
      <br>
    ...
    <p>
      ...
      die Skalierbarkeit und Leistung zu verbessern oder die Kundenbetreuung durchzuführen.
    </p>
    ...
    <ul>
      ...
      <li>für die Verarbeitungen nach Nummer 3 Art. 6 Abs. 1 S.1 lit. c DSGVO (rechtliche Verpflichtung zur Umsetzung
        ...
        S.1 lit. f DSGVO (berechtigte Interessen zur Datenverarbeitung für die Netz- und Informationssicherheit) sowie
        für</li>
      <li>die Verarbeitungen nach den Nummern 4-5 Art. 6 Abs. 1 S.1 lit. f DSGVO (berechtigte Interessen). Die
        berechtigten Interessen unserer Datenverarbeitung bestehen darin, unser Angebot nutzerfreundlich zu gestalten
        und zu optimieren.</li>
      <li>Die vorstehend genannten Daten werden nach einer definierten Zeit vom Server automatisiert gelöscht. Sofern
        Daten zu Zwecken nach Nummern 2-5 länger verarbeitet werden, erfolgt die Anonymisierung oder Löschung, wenn die
    ...
    <p>
      ...
      d.h. andere natürliche oder juristische Personen
      außer Ihnen (der betroffenen Person), dem Verantwortlichen oder dem Auftragsverarbeiter und deren zur
    ...
    <ul>
      <li>für den Fall, dass für die Weitergabe nach Art. 6 Abs. 1 S. 1 lit. c DSGVO eine gesetzliche Verpflichtung
        besteht, bspw. an Finanz- oder Strafverfolgungsbehörden;</li>
      <li> die Weitergabe ist nach Art. 6 Abs. 1 S. 1 lit. f DSGVO zur Geltendmachung, Ausübung oder Verteidigung von
        Rechtsansprüchen erforderlich und es besteht kein Grund zur Annahme, dass Sie ein überwiegendes schutzwürdiges
        Interesse an der Nichtweitergabe Ihrer Daten haben; eine solche Weitergabe kann bspw. im Falle von Angriffen auf
        unsere IT-Systeme an staatliche Einrichtungen und Strafverfolgungsbehörden erfolgen.</li>
    </ul>
    ...
    <p>
      Im Übrigen wird unser FOKUS Digital gemäß Art. 28 DSGVO von unserem Vertragspartner Urban Software Institute GmbH,
      Zwickauer Str. 223a, 09116 Chemnitz, Deutschland ausschließlich auf Servern der EU gehostet.
    </p>
    <p>
      Eine Übermittlung von personenbezogenen Daten an ein Drittland (außerhalb der EU) oder eine internationale
    ...
    <div class="alert alert-success" role="alert">
      ...
      <p>
        ...
        dies gilt auch für ein auf diese Bestimmung gestütztes Profiling von Artikel 4 Nr. 4 DSGVO.
      </p>
      <p>
        ...
        die Ihre Interessen, Rechte und Freiheiten überwiegen, oder die Verarbeitung dient der Geltendmachung, Ausübung
